/*
 * benker_plugin.c - skeleton vpp engine plug-in
 *
...
#include <benker_plugin/benker_plugin.api_enum.h>
#include <benker_plugin/benker_plugin.api_types.h>
...
static clib_error_t *
benker_plugin_enable_disable_command_fn (vlib_main_t * vm,
                                   ...
                                   vlib_cli_command_t * cmd)
{
  ...
  default:
    return clib_error_return (0, "benker_plugin_enable_disable returned %d",
                              rv);
    }
  return 0;
}
...
/* *INDENT-OFF* */
VLIB_CLI_COMMAND (benker_plugin_enable_disable_command, static) =
{
...
/* API message handler */
static void vl_api_benker_plugin_enable_disable_t_handler
(vl_api_benker_plugin_enable_disable_t * mp)
{
  vl_api_benker_plugin_enable_disable_reply_t * rmp;
  benker_plugin_main_t * bmp = &benker_plugin_main;
  int rv;
...
/* API definitions */
#include <benker_plugin/benker_plugin.api.c>

static clib_error_t * benker_plugin_init (vlib_main_t * vm)
{
  benker_plugin_main_t * bmp = &benker_plugin_main;
...
VLIB_INIT_FUNCTION (benker_plugin_init);

/* *INDENT-OFF* */
VNET_FEATURE_INIT (benker_plugin, static) =
{
  .arc_name = "device-input",
  .node_name = "benker_plugin",
